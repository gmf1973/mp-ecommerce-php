<?php
  ...
  $preference->back_urls = array(
    "success" => "http://mercadopago.test:8000/success",
    "failure" => "http://mercadopago.test:8000/failure",
    "pending" => "http://mercadopago.test:8000/pending"
  );
  $preference->auto_return = "all";
  $preference->notificacion_url = "http://mercadopago.test:8000/webhook/";
  ...
  $payer->date_created = "2020-04-09T12:58:41.425-04:00";
  $payer->phone = array(
    "area_code" => "52",
    "number" => "5549737300"
  );
